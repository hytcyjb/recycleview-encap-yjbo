...
public abstract class RecyclerMoreKindViewAddAdapter<T> extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public RecyclerMoreKindViewAddAdapter(Context context, List<T> datas, MutipleTypeSupport typeSupport) {
        this(context, -1, datas);
        this.mMutipleTypeSupport = typeSupport;
    }


    public RecyclerMoreKindViewAddAdapter(Context context, int layoutId, List<T> datas) {
