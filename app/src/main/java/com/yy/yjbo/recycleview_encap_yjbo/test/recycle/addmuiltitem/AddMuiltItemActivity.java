...
//        headerView1 = LayoutInflater.from(this).inflate(R.layout.layout_header1, mRecyclerView, false);
...
//                }else if (countButtomClick == 6){//显示下一页的数据 or 插入一个页面
//                    countButtomClick = 0;
...
//
//                    if (headerView1 != null){
//                        mWrapRecyclerAdapter.addHeaderView(headerView1);
//                    }
//                }
//            }
//        });
